    ...
    <div class="main" id="main">
        <div class="d-flex justify-content-center align-item-center ">
          <div class="row align-items-center">
            <div class="col-6  ">
              <h1 class="main-parallax" data-speed="-10">Find Your Car</h1>
            </div>
              <div class="col-6 text-end ">
                  <img src="car.png" alt="Cover image of a car">
                  <hr>
              </div>
          </div>
        </div>
...
if ($_SERVER['REQUEST_METHOD'] == "GET")
{
    ...
    $query = "SELECT * FROM `cars` WHERE  `manufacturer`  LIKE '%$search_result%' OR `car_model` LIKE '%$search_result%' OR `car_type` LIKE '%$search_result%' ";
}
else {
